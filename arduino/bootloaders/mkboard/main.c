 ...
 * 
 * Modified by Ilya Danilov (idanilov.ru@gmail.com) 
 * for MKBoard project (https://github.com/mk90)
 * 2011-07-17: bootloader activation indicated by LED
 */
